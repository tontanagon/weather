...
const fetchPosts = () => {
  const url = `https://api.openweathermap.org/data/2.5/forecast?lat=${newLat.value}&lon=${newLon.value}&appid=${apikey.value}&units=metric`;
...
<main class="container-fluid">
  <div class="row text-start">
    <div class="col-2 ">
      ...
      <div class="" role="search" style="padding-top: 46px;">
            <input class="form-control me-2" type="search" placeholder="Latitude" aria-label="Latitude" v-model="newLat">
            <input class="form-control me-2" type="search" placeholder="Longitude" aria-label="Longitude" v-model="newLon">
  ...
  <div class="col-9 ">
    ...
    <h6 class="border-bottom pb-2 mb-0 " v-for="(i,index) in list" :key="index">สภาพอากาศ 5 วัน ( {{ i.name }} ) </h6>
